...
as_tsibble(velec_str$input$data) %>%
  ...
  mutate(
    ...
    Trend = velec_str$output$predictors[[1]]$data,
    Season_year = velec_str$output$predictors[[4]]$data,
    Season_week = velec_str$output$predictors[[3]]$data,
    Season_day = velec_str$output$predictors[[2]]$data,
  ) %>%
