...
dy_graph <- list(
  dygraph(decomp.xts$Demand, main = "", y = "Demand", group = "A", width = 990, height = 90) |>
    dyAxis("x", axisLabelWidth = 0),
  dygraph(decomp.xts$Season_year, main = "", y = "Annual seasonality", group = "A", width = 990, height = 90) |>
    dyAxis("x", axisLabelWidth = 0),
  dygraph(decomp.xts$Season_week, main = "", y = "Weekly seasonality", group = "A", width = 990, height = 90) |>
    dyAxis("x", axisLabelWidth = 0),
  dygraph(decomp.xts$Season_day, main = "", y = "Daily seasonality", group = "A", width = 990, height = 90) |>
    dyAxis("x", axisLabelWidth = 0),
  dygraph(decomp.xts$Temp, main = "", y = "Temperature", group = "A", width = 990, height = 90) |>
    dyAxis("x", axisLabelWidth = 0),
  dygraph(decomp.xts$Remainder, main = "", y = "Remainder", group = "A", width = 990, height = 90) |>
